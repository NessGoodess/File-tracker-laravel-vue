            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    <div class="flex flex-col items-center justify-center">
                        <div
                            class="flex flex-col items-center justify-center gap-6 p-6 bg-white rounded-lg w-2/4">

                            <img :src="getImageUrl('images/LogoB.png')" alt="Logo" />
                            <!--<img src="path/to/logo.png" alt="Logo" class="h-24 w-24" />-->
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-black/70">
                    ...
                    &copy; 2025 Secretaría Administrativa. UABJO.
                </footer>
            </div>
        </div>
    </div>
